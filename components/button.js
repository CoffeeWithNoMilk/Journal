...
const AppButton = ({onPress, title, img, taskIsComplete, type, size}) => {
    ...
    const appButtonContainer = {
        backgroundColor: size === 'small' && taskIsComplete === true ? '#6CBE49' : size === 'smallest' && taskIsComplete === true ? '#6CBE49' : 
        size === 'large' && taskIsComplete === true ? '#6CBE49' : 'rgba(250, 250, 250, 0.1)' ,
